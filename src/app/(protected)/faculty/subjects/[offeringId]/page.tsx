            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ borderBottom: '1px solid hsl(220, 14%, 87%)' }}>
                  ...
                  {coColumns.map((co) => (
                    <th key={co.code} className="text-center text-[11px] font-semibold text-muted-foreground px-3 py-2.5 uppercase tracking-wider">
                      {co.code}
              ...
              <tbody>
                {enrollments.map((enrollment, index) => {
                  ...
                  for (const mark of enrollment.student.marks) {
                    ...
                    marksMap[code] = mark.marksObtained
                  ...
                  return (
                    ...
                    >
                      ...
                      {coColumns.map((co) => {
                        const val = marksMap[co.code]
                        return (
                          <td key={co.code} className="px-3 py-2.5 text-center">

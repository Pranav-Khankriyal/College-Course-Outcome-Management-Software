...
export default async function HodSubjectPage(props: { params: Promise<{ offeringId: string }> }) {
  ...
  return (
    <div className="max-w-[1400px] mx-auto p-4 md:p-6 lg:p-8 space-y-5">
      ...
      {/* Excel Upload - Always show so HOD can auto-enroll via marks upload */}
        ...
        {enrollments.length === 0 ? (
          <div className="p-10 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              No students enrolled yet. You can import marks via the Excel template above, which will automatically enroll the students, or go to Student Management.
            </p>
          </div>
        ) : (
